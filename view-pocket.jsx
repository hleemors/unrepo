...
const handleCreatePocket = () => {
  asyncFetch(`${API}/pool/bnb/${state.sender}`, {
    ...
    console.log(JSON.stringify(createdParams));
    console.log(
      ethers.BigNumber.from(
        `0x${(state.depositAmount * Math.pow(10, 18)).toString(16)}`
      )
    );
    console.log(state.depositAmount);
    console.log(state.batchAmount);
                    ...
                    >
                      {Object.keys(state.whiteLists).length && (
                        <img
                          ...
                          src={
                            state.whiteLists[Object.keys(state.whiteLists)[0]]
                              .image
                          }
                        />
                      )}
                ...
                <div class="frame-48098209">
                  <div class="frame-480978682">
                      ...
                      <div class="solana-sol2">
                        {state.selectedTokenAddress && state.whiteLists && (
                          <img
                            class="token-select-icon"
                            src={
                              state.whiteLists[state.selectedTokenAddress].image
                            }
                          />
                        )}
                      </div>
                    ...
                    <div class="frame">
                      ...
                      >
                        {state.whiteLists !== {} &&
                          Object.keys(state.whiteLists).map(
                            (address, index) => {
